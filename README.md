...
---
# Selling_Car_Price
This machine learning model allows us to predict the selling price of a car from the kms driven, present price, fuel type, seller type, transmission and age of the car.
